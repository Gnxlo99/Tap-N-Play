...
const HeroSection: React.FC<HeroSectionProps> = ({ game }) => {
  return (
    <div className="relative rounded-2xl overflow-hidden mb-12 shadow-2xl shadow-violet-900/20">
      <img src={game.imageUrl} alt={game.title} className="w-full h-[500px] object-cover" />
      ...
      <div className="absolute bottom-0 left-0 p-8 md:p-12 text-white w-full md:w-2/3 lg:w-1/2">
        ...
        <div className="flex items-center space-x-4">
          <button className="bg-violet-600 hover:bg-violet-500 text-white font-bold py-3 px-8 rounded-full transition-transform duration-300 hover:scale-105 flex items-center space-x-2 shadow-lg shadow-violet-600/30">
            <Icon icon="fa-play" />
            <span>Play Now</span>
          </button>
