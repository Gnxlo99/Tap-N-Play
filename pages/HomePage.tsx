...
const HomePage: React.FC<HomePageProps> = ({ onPlayGame }) => {
    return (
        <div className="p-4 sm:p-6 lg:p-8">
            <HeroSection game={FEATURED_GAME} onPlay={onPlayGame} />
            ...
            <GameGrid title="Our Game" games={MOCK_GAMES} onPlay={onPlayGame} />
        </div>
    );
};
