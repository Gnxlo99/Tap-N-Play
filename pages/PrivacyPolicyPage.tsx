    ...
    <div className="text-gray-300 bg-[#0a0a0a] p-4 sm:p-6 lg:p-12">
      <div className="max-w-4xl mx-auto prose prose-invert prose-h1:text-4xl prose-h1:font-extrabold prose-h1:text-violet-400 prose-h2:text-2xl prose-h2:font-bold prose-h2:text-violet-300 prose-h3:text-xl prose-h3:font-bold prose-a:text-violet-400 hover:prose-a:text-violet-300">
        ...
        <ul>
          ...
          <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Tap N Play.</p>
          </li>
          <li>
          ...
          <li>
            <p><strong>Website</strong> refers to Tap N Play, accessible from <a href="https://tapnplay.online" rel="external nofollow noopener" target="_blank">tapnplay.online</a></p>
          </li>
          <li>
